...
<template>
    <div class="col bg-gradient m-5">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="floatingInput" placeholder="url">
            <label for="floatingInput">Url image</label>
        </div>
        <button type="button" class="btn btn-danger ms-5 ">Deshacer</button>
        <button type="button" class="btn btn-info ms-5">Aceptar</button>
